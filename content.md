...
$p$値は図11.3グラフ中の「←」部分を足しあげた$3.2\%$となる。
<div align="center">
...
$p$値$=2.4\%<2.5\%$となり帰無仮説「$\theta=0.5$」は棄却される。
...
<br>
- コインは$24$回中$7$回が表でした。→そうですか
- 　　釘は$24$回中$7$回が表でした。→いやいやいや！
